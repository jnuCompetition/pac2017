...
def train(sc,
    ...
    texts = getTrainData(raw_data,params["act"],params["target"],params["target_value"],params["subsample_num"])
...
if __name__ == "__main__":
    ...
    params["logDir"] = "logs/"
    params["act"] = "ApplePay"
    params["subsample_num"] = 2000
    params["target"] = "act"
    params["target_value"] = [u"ApplePay",u"银联钱包",u"银联62",u"云闪付"]
